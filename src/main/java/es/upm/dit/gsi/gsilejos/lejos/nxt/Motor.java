...
import es.upm.dit.gsi.gsilejos.lejos.robotics.navigation.TachoPilot;
...
public class Motor {
    ...
    public static final Motor A = new Motor (); // LEFT
    public static final Motor B = new Motor (); // CABEZA
    public static final Motor C = new Motor (); // RIGHT
     ...
     * @param direction
     */
    public void setMotor(TachoPilot piloto, byte direction) {
        this.piloto = piloto;
