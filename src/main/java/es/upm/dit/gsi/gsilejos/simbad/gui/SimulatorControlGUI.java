...
public class SimulatorControlGUI extends JPanel implements ActionListener {
    ...
    JFrame parentFrame;
    SimulatorChronometerGUI chronometer;
    Font smallFont;
    
    public SimulatorControlGUI(JFrame parentFrame,Simulator simulator, SimulatorChronometerGUI chronometer) {
    ...
    void createGUI() {
        ...
        createRadioButton(panel2, bgroup, "2.0", "tf2.0",false);
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        if (action.equals("run")) {
            ...
            chronometer.resetCounter();
            simulator.resetSimulation();
        } else if (action.equals("restart")) {
            simulator.restartSimulation();
            chronometer.restartCounter();
